...
### Environment settings:
  ...
  #### Product Settings
  - **Behavior → Release Channel**: General Availability & Preview
...
## L. Hyperautomation
Hyperautomation is the use of various technologies to rapidly identify inefficiencies and automate as many business processes as possible. These technologies include:
...
## M. Expression
- **Case insensitive:** Expressions are not case-sensitive.
- **Optional parameter:** Suffix `?` in an input param of a function is considered optional parameter
- **Types of Functions:**
  - String functions:
...
## N. Options under Context Menu of an Actions:
- Copy action
- Add a note
- Settings
    - Secure Inputs
